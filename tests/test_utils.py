import pytest
from pynajax.utils import _revert_epochs, _get_complement_slicing, _odd_ext_multiepoch, _get_idxs
import numpy as np
...
def test_revert_epoch(time_array, starts, ends, expected_out):
    istart, iend = _get_idxs(time_array, starts, ends)
    irev = _revert_epochs(istart, iend)
